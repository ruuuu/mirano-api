...
const corsOptions = {
  origin: ['http://127.0.0.1:5500', 'http://localhost:5173', 'https://mirano.vercel.app', 'https://mirano-reactnew.onrender.com' , 'https://ruuuu.github.io'], // Замените на URL вашего фронтенда
  credentials: true,
};
